...
client.on('ready', async () => {
 ...
 client.user.setActivity(`discord.gg/pearly`, { type:'WATCHING' })
  
  console.log("ukqzn v12 abone botu aktif!")
});
...
//bot oynuyor ayarlama bitiş (ukqzn)

//komutları yükler (ukqzn)
